...
SUCCESS = {"message": "SUCCESS.", "code": 200}, 200
INVALIDATED = {"message": "INVALIDATED.", "code": 200}, 200
ALREADY_INVALIDATED = {"message": "INVALIDATED.", "code": 200}, 200
OLD_PASS_DOES_NOT_MATCH = {"message": "Old password does not match.", "code": 999}, 999


def m_return(message, code):
    make_response(jsonify({'message': str(message)}), code)
